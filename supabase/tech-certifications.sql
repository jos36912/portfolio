-- Actualización incremental: carrusel de certificados tech.
-- Nueva columna booleana 'tech' en certifications, expuesta en
-- certifications_public y get_recruiter_content.
-- Idempotente: ejecutar en SQL Editor de Supabase.

alter table certifications add column if not exists tech boolean not null default false;
